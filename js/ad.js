...
function storey($select,$width){
	...
	// console.log('是否有类'+!$($select).hasClass('in'));
	// console.log(scrollTop = $width && !$($select).hasClass('in'));
...
$(window).scroll(()=>{//cpu
	...
	storey('.container-fluid>.cpu>h5:last',2200);
	
	storey('.container-fluid>.cpu>.clearfix',2300);
	// console.log(scrollTop);
